...
describe MetaCommit::Plugin::Ruby::Diffs::MethodDeletion do
...
module TestModule
  class TestClass
    def test_method
      ...
      old_ast_path = MetaCommit::Factories::ContextualAstNodeFactory.new.create_ast_path(source_ast, 3)
...
module TestModule
  class TestClass
    def test_method
      ...
      eos
      source_ast = MetaCommit::Plugin::Ruby::Parsers::Ruby.new.parse(ast_content)
      old_ast_path = MetaCommit::Factories::ContextualAstNodeFactory.new.create_ast_path(source_ast, 4)

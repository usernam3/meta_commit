...
describe MetaCommit::Models::Diffs::ModuleDeletion do
...
module TestModule
  class TestClass
    def test_method
      ...
      old_ast_path = MetaCommit::Models::Factories::ContextualAstNodeFactory.new.create_ast_path(source_ast, 1)
...
module TestModule
  class TestClass
    def test_method
      ...
      eos
      source_ast = Parser::CurrentRuby.parse(ast_content)
      old_ast_path = MetaCommit::Models::Factories::ContextualAstNodeFactory.new.create_ast_path(source_ast, 6)

...
module TestModule
  class TestClass
    def test_method
      ...
      new_ast_path = MetaCommit::Models::Factories::AstPathFactory.new.create_ast_path(source_ast, 3)
...
module TestModule
  class TestClass
    def test_method
      ...
      eos
      source_ast = Parser::CurrentRuby.parse(ast_content)
      new_ast_path = MetaCommit::Models::Factories::AstPathFactory.new.create_ast_path(source_ast, 4)
